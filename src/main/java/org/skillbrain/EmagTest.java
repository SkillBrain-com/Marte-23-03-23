...
//            simpleEmageHomePageExample();
    ...
    private static void simpleEmageHomePageExample() {
        WebElement acceptGdpr =
                driver.findElement(By.cssSelector(".btn.btn-primary.js-accept.gtm_h76e8zjgoo.btn-block"));
        WebElement gdprBanner = driver.
                findElement(By.cssSelector(".gdpr-cookie-banner.js-gdpr-cookie-banner.pad-sep-xs.pad-hrz-none.show"));
